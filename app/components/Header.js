      ...
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
        <div className="flex items-center lg:flex-1 ">
          <a href="#" className="-m-1.5 p-1.5">
            <span className="sr-only">Tech Monohor</span>
            <Image
              alt=""
              src={logo}
          ...
          <h1 className='ml-2 font-bold'>Tech Monohor IT</h1>
        </div>
          ...
          <div className="mx-auto max-w-7xl px-6 pb-32 pt-36 sm:pt-60 lg:px-8 lg:pt-32">
            <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
              <div className="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
                <p className="mb-8 text-pretty text-lg font-medium text-gray-500 sm:max-w-md sm:text-xl/8 lg:max-w-none">
                We are a freelance Web Development Agency.                </p>
                <h1 className="text-pretty text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl">
                Our Code, Your  business Success.
                </h1>
